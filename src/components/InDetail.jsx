        ...
        <WrapperCard className=' pt-24'>
             <div className='flex flex-col-reverse lg:flex-row gap-12 items-center bg-[#e3e3e3]'>
                <div className=' basis-1/4 '>
                    ...
                    <h1 className=' text-blue-800 text-3xl lg:text-5xl font-extrabold mb-8 lg:w-32'>AHEAD IN MARITIME EXCELLENCE</h1>
                ...
                <div className=' relative basis-3/4 '>
                    <img className=' h-[30rem] w-[50rem] ' alt="world map" src={map}/>
                    <div className=' h-[30rem] w-full top-0   absolute'>
                        <img className=' h-full w-full' src={marks}/>
                    </div>
                </div>
            </div>
            <div className=' mt-20 grid sm:flex lg:grid gap-3 text-white md:font-bold w-fit'>
                ...
                <span className='p-3 self-center navlink w-fit bg-blue-800'>VALUES</span>
                <span className='p-3 self-center text-center navlink w-fit bg-blue-800'>VISION / MISSION</span>
            </div>
        </WrapperCard>
   </div>
  )
