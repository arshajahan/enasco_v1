            ...
            <WrapperCard className=''>
                <div className='pt-16 text-[#005a96] h-fit'>
                    ...
                    <div className='flex flex-wrap gap-7'>
                        <div className='flex flex-col basis-full lg:basis-1/3 xl:basis-1/4 flex-grow bg-white'>
                            <img src={n2} className=' h-60 w-full' alt='News 1' />
                            <div className='flex flex-col justify-between p-8 gap-4 h-full '>
                        ...
                        <div className='flex flex-col basis-full lg:basis-1/3 xl:basis-1/4 flex-grow '>
